...
<section>
    ...
    <h2 class="SubTitulo">
        Você, profissional, demonstra suas habilidades, enquanto os clientes, se
        satisfazem com o seu serviço.<br />
        Ficaremos animados com seus resultados e conseguiremos credibilidade para você e para o nosso site!
    </h2>
    <NavLink to="login"> 
    <div>
